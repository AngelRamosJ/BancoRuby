var tamCadMaxCalle, tamCadMaxCiudad, tamCadMaxColonia, tamCadMaxExtInt, tamCadMaxMunicipio, tamCadMinCalle, tamCadMinCiudad, tamCadMinColonia, tamCadMinExtInt, tamCadMinMunicipio;
...
$(document).ready(function(){
    $('#formulario_localidades').validate({
        rules: {
            'localidad[tipo]': {
            required: true
            },
