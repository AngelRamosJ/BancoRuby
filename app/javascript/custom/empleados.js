var edadMax, edadMin, tamCadMax, tamCadMaxCorreo, tamCadMaxSalario, tamCadMin;
...
$.validator.addMethod('RFC', function(value, element) {
    if (value !== '') {
    return new RegExp("^[A-ZÑ&]{3,4}[0-9]{6}(?:[A-Z0-9]{3})?$").test(value);
    } else {
    return false;
    }
...
$.validator.addMethod('CURP', function(value, element) {
    if (value !== '') {
    return new RegExp("[A-Z]{4}[0-9]{6}[A-Z]{7}[0-9]").test(value);
    } else {
    return false;
    }
...
$.validator.addMethod('Correo', function(value, element) {
    if (value !== '') {
    return new RegExp("[a-zA-Z0-9-._]+@[a-zA-Z0-9-._]+[.]{1}[a-z]{2,4}").test(value);
    } else {
    return false;
    }
}, 'Correo INvalido, usa el formato angel_5@gmail.com');

$.validator.addMethod('Password_Mayuscula', function(value, element) {
    if (value !== '') {
...
$.validator.addMethod('Password_Caracter_Especial', function(value, element) {
    if (value !== '') {
...
$.validator.addMethod('Password_Numero', function(value, element) {
    if (value !== '') {
...
$(document).ready(function(){
    ...
    $('#formulario_empleados_editar').validate({
        rules: {
            'empleado[nombre]': {
            required: true,
            minlength: tamCadMin,
