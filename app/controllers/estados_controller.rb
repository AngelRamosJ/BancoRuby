class EstadosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @estado.save
        format.html { redirect_to @estado, notice: "Estado creado exitosamente." }
  ...
  def update
    respond_to do |format|
      if @estado.update(estado_params)
        format.html { redirect_to @estado, notice: "Estado actualizado exitosamente." }
  ...
  def destroy
    @estado.destroy
    respond_to do |format|
      format.html { redirect_to estados_url, notice: "Estado eliminado exitosamente." }
  ...
  private
    ...
    def estado_params
      params.require(:estado).permit(:nombre, :descripcion, :pais_id)
    end
end
