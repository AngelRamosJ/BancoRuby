...
class PruebasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prueba" do
    assert_difference("Prueba.count") do
      post pruebas_url, params: { prueba: { descripcion: @prueba.descripcion, nombre: @prueba.nombre } }
    end
  ...
  test "should update prueba" do
    patch prueba_url(@prueba), params: { prueba: { descripcion: @prueba.descripcion, nombre: @prueba.nombre } }
